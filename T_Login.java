	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			con = new DBConnection().getConnection();
			 PreparedStatement ps=con.prepareStatement("select * from teacher where uname=? and password = ?");
			 ...
			 if(rs.next()) {
				 ...
				 RequestDispatcher rd = request.getRequestDispatcher("Teacher_Official_Portal.html");
		         ...
		         out.println("<a href=Teacher_Login.html>Click here</a>");
			 }
		}catch(Exception e) {
			e.printStackTrace();
		}finally {
